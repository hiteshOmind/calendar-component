  ...
  return (
    <Box display={"flex"} flexDirection={"column"} gap={"32px"}>
      ...
      <Box>
        ...
        <Text marginTop={"12px"}>You did not receive the code ? <span style={{color:"rgba(18, 110, 54, 1)", textDecoration:"underline" }}>Resend in (1:00)</span> Or <span style={{color:"rgba(18, 110, 54, 1)", textDecoration:"underline"}}>Modify phone number</span></Text>
      </Box>
    </Box>
  );
}

export default ActivateAccountForm2;
